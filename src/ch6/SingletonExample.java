...
//		Singleton obj2 = new Singleton();
		...
		obj1.increaseNum();
		System.out.println("obj1.increaseNum() 실행 시 : " + obj1.getNum());
		System.out.println("obj2.increaseNum() 실행 시 : " + obj2.getNum());
...
class Singleton {
	// 싱글톤 디자인 생성 단계..
	// 1. 필드 생성..
	//  필드는 자유롭게 만들되 객체(자신)에 대한 멤버변수를 생성. 접근 제한자는 private
	private String str;
	private int num;
