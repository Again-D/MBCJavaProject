...
public class ModifierExample {
	...
	/*
	 *  접근 제한자
	 *   : 중요한 필드(멤버변수)나 메서드가 와부로 노출되지 않도록 해서 객체의 무결성을 유지하기 위해서
	 *   접근제한을 둘때 사용함.
	 *   무결성 : 변함이 없이 고유하다는 특징.
	 *   
...
//				"\tnum3 = " + sup.num3 +				// default이기 때문에 같은패키지여야 접근 가능
				"\tnum4 = " + sup.getNum4()				// 패키지 내에 있는 public 메서드를 사용해서 private에 접근
				);
...
class Sub extends Super { // extends를 사용하여 상속받을 부모를 지정!
	...
	// 생성자에 대한 접근 제한...
	// public : 모든 패키지에서 생성자를 호출 할 수 있다. (객체 생성 가능)
	// protected : 같은 패키지 혹은 부모 자식 관계에서 생성자를 호출 할 수 있다.
	...
	public void print() {
		...
		// num2는 같은 패키지 인가요? 아니요. 상속 관계인가요? 예
