...
public class GenericExample5 {
	...
	// 와일드카드 타입 파라미터 : ?
	// 제너릭 타입을 매개값이나 리턴타입으로 사용할 때 범위에 있는 모든 타입으로 대체할 수 있는
	// 타입 파라미터를 의미함.
...
//		Course.registerCourse2(new Applicant<Worker>(new Worker()));
		Course.registerCourse2(new Applicant<Student>(new Student()));		// 여기서 부터 학생 및 자식 객체
...
class Course {	// 여기서 와일드 카드 사용
	...
	// 학생만 등록 가능
	// <? extends Student> 의미는 Student 객체를 포함한 하위 객체 들을 의미하게 됨.
	...
	// 직장인 및 일반인만 등록 가능
	// <? super Worker> 의미는 Worker 객체를 포함하는 부모 객체 까지라는 의미.
